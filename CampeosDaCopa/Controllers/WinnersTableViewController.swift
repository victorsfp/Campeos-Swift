...
class WinnersTableViewController: UITableViewController {
    ...
    func loadWorldCups(){
        ...
        do {
            self.worldCups = try JSONDecoder().decode([WorldCup].self, from: jsonData)
        } catch {
    ...
    //QUANDO USO APENAS UMA SESSAO NAO NECESSITO DESSE METODO, SESSOES DA TABLE
    override func numberOfSections(in tableView: UITableView) -> Int {
        // #warning Incomplete implementation, return the number of sections
        return 1
    }

    //QUANTIDADE DE LINHA POR SESSOES, E PODEMOS FAZER FILTRAGEM ATRAVES DO PARAMETRO section
